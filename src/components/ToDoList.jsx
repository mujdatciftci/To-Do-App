  ...
  return (
    <div>
      <div className="todolist-container ">
        ...
        <ItemList inputText={inputText} setInputText={setInputText} />
        ...
        <Modal setIsModalOpen={setIsModalOpen}>
          <form className="flex flex-col gap-8">
            <label className="relative flex flex-col justify-center mt-3">
              <input className="w-full px-4 rounded-md h-[65px] text-sm text-white bg-[#423A6F] focus:outline-none peer " 
              type="text" 
              onBlur={inputChange}
              />
            ...
            <button className="todolist-btn-add mx-auto" type="submit" onClick={addTask} >Add Task</button>
          </form>
        </Modal>
      }
      </div>
